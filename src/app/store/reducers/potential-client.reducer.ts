...
export const initialState: State = {
  ...
  wayToAddList: [
    new WayToAdd(0, 'Через Demo тур', 'fas fa-laptop'),
    new WayToAdd( 1, 'Добавление в skype', 'fab fa-skype'),
    new WayToAdd( 2, 'Регистрация на сайте', ''),
    new WayToAdd( 3, 'Активный поиск клиента', 'fas fa-search'),
    new WayToAdd( 4, 'Письмо на почту', 'fas fa-envelope'),
    new WayToAdd( 10, 'Найден на выставке', 'fas fa-comments'),
    new WayToAdd( 11, 'Рекомендации другой компании', ''),
    new WayToAdd( 13, 'Телефонный звонок', 'fas fa-phone-volume'),
    new WayToAdd( 14, 'Онлайн чат на сайте', 'fas fa-comment'),
  ],
