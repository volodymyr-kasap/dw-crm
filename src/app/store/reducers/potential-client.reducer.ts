...
export const initialState: State = {
  ...
  managersList: null,
  eventsActionList: [
    new EventsAction(EventsActionEnum.TelephoneConversation, 'Разговор', 'fas fa-phone', 'color-158f44', 'bg-158f44 color-white'),
    new EventsAction(EventsActionEnum.Correspondence, 'Переписка', 'fas fa-sms', 'color-db8b22', 'bg-c51c24 color-white'),
    new EventsAction(EventsActionEnum.Meeting, 'Встреча', 'fas fa-handshake', 'color-4e70ba', 'bg-c51c24 color-white'),
    new EventsAction(EventsActionEnum.Carry, 'Перенос', 'fas fa-random', '', 'bg-000000 color-white'),
    new EventsAction(EventsActionEnum.NoAnswer, 'Нет ответа', 'fas fa-phone-slash', 'color-c51c24', 'bg-c51c24 color-white'),
    new EventsAction(EventsActionEnum.Presentation, 'Презентация', 'fas fas fa-eye', 'color-c51c24', 'bg-e71baa color-white')
  ],
  eventResultList: [
    ...
    new EventsResult(EventsResultEnum.AtTheFinishStage, 'fas fa-laugh-wink', 'color-e71baa', 'На стадии финиша - ДОБИТЬ!', 'bd-DC0083 color-white'),
    new EventsResult(EventsResultEnum.Cooperation, 'fas fa-laugh-squint', 'color-158f44', 'Сотрудничество', 'bd-7DBD36 color-white'),
    new EventsResult(EventsResultEnum.Pause, 'fas fa-pause-circle', 'color-db8b22', 'Пауза - неактивный клиент', 'bd-FF7123 color-white'),
    new EventsResult(EventsResultEnum.Renouncement, 'fas fa-times-circle', 'color-c51c24', 'Отказ', 'bd-E30000 color-white'),
    new EventsResult(EventsResultEnum.RevisionOfConditions, 'fas fa-file-signature', 'color-2cd49f',  'Пересмотр условий', 'bd-25BEB2 color-white'),
    new EventsResult(EventsResultEnum.ChoosingAnotherCompany, 'fas fa-search', 'color-874f4f', 'Выбор другой компании', 'bd-8E1600 color-white'),
    new EventsResult(EventsResultEnum.NotRelevant, 'fas fa-window-close', 'color-6c757d', 'Не заинтересован', 'bd-BABABA color-white'),
  ],
  wayToAddList: [
